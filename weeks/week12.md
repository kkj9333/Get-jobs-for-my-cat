...
为了优化出一个可以指导代理在每个上下文上做出适当的决策，而不受到灾难性干扰的不利影响的Q函数，我们结合[原始损失](https://github.com/kkj9333/Get-jobs-for-my-cat/blob/main/weeks/week12.md#145)和[蒸馏损失](https://github.com/kkj9333/Get-jobs-for-my-cat/blob/main/weeks/week12.md#152)来形成一个联合优化框架。即，我们通过以下优化目标（_optimization objective_）来解决灾难性干扰问题：<br>
...
### 基线标准
与DQN， Rainbow， SRNN，DSOM，TCNN的单任务RL基线方法进行了比较。
